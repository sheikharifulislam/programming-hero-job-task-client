...
const UpdateStudentInfo = () => {
    ...
    useEffect(() => {
        axios.get(`https://safe-ocean-22917.herokuapp.com/single-student?studentId=${studentId}`)
        .then((response) => {
    ...
    const handleForm = e => {
        ...
        axios.patch(`https://safe-ocean-22917.herokuapp.com/update-student-info?studentId=${studentId}`,studentData)
        .then((response) => {
