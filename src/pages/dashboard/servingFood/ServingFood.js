...
const ServingFood = () => {
    ...
    const customStyles = {
      ...
      useEffect(() => {
        axios.get(`https://safe-ocean-22917.herokuapp.com/all-foods`)
        .then((response) => {
    ...
    const handleSearch = e => {
        e.preventDefault();
        setIsLoading(true);
        axios.get(`https://safe-ocean-22917.herokuapp.com/single-student?studentRoll=${studentRoll}`)
        .then((response) => {
    ...
    const handleServingForm = e => {
        ...
        axios.get(`https://safe-ocean-22917.herokuapp.com/serving-food?roll=${roll}&&date=${date}&&shift=${shift}`)
        .then((response) => {            
            if(response.data === null) {               
                axios.post(`https://safe-ocean-22917.herokuapp.com/add-serving-food`,updateServingData)
                .then((response) => {
