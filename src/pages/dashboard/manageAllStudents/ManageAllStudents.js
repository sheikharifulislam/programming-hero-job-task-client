...
const ManageAllStudents = () => {
    ...
    useEffect(() => {
        setDataLoading(true);
        axios.get(`https://safe-ocean-22917.herokuapp.com/all-students?currentPage=${currentPage}&&size=${size}`)
        .then((response) => {
    ...
    const handleStudentDeleteBtn = (e, id) => {             
        ...
        .then((value) => {
            if(value) {
                axios.delete(`https://safe-ocean-22917.herokuapp.com/delete-single-student?studentId=${id}`)
                .then((response) => {
    ...
    const handleUpdateStatus = (status) => {
        axios.patch(`https://safe-ocean-22917.herokuapp.com/update-student-status?studentsId=${selectStudent}`,{status: status})
        .then((response) => {
