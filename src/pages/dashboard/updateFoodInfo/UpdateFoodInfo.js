...
const UpdateFoodInfo = () => {
    ...
    useEffect(() => {
        axios.get(`https://safe-ocean-22917.herokuapp.com/all-foods?foodId=${foodId}`)
        .then((response) => {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        delete foodData._id;
        axios.patch(`https://safe-ocean-22917.herokuapp.com/update-food-info?foodId=${foodId}`,foodData)
        .then((response) => {
